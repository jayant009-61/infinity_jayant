...
const GameIntro = () => {
  return (
    <div className="game-container">
      ...
      <div className="a">
        <img src="/pic.webp" alt="" width={200} className='pic'/><br /><br /><br />
        <h1 className='jayant'>My self Infinty Jayant</h1><br />
        <h2 className='code'>I am on the path to be a coder</h2><br />
